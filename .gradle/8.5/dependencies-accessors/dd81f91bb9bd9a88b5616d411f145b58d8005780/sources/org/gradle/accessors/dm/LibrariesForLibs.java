...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final JetpackPluginAccessors paccForJetpackPluginAccessors = new JetpackPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of plugins at plugins.jetpack
         */
        public JetpackPluginAccessors getJetpack() {
            return paccForJetpackPluginAccessors;
        }
    ...
    public static class JetpackPluginAccessors extends PluginFactory {
        private final JetpackComposePluginAccessors paccForJetpackComposePluginAccessors = new JetpackComposePluginAccessors(providers, config);

        public JetpackPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of plugins at plugins.jetpack.compose
         */
        public JetpackComposePluginAccessors getCompose() {
            return paccForJetpackComposePluginAccessors;
        }

    }

    public static class JetpackComposePluginAccessors extends PluginFactory {

        public JetpackComposePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for jetpack.compose.compiler to the plugin id 'org.jetbrains.kotlin.plugin.compose'
             * with versionRef 'compose.compiler'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompiler() { return createPlugin("jetpack.compose.compiler"); }
